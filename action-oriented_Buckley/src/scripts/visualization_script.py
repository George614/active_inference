...
agents in a trial. Single agent (without model averaging) is learned and
mutilple agents learned separately are saved.
...
if __name__ == "__main__":
    for n in range(N_AGENTS):
        ...
        with writer.saving(fig, "../videos/full_agent_{}.mp4".format(n), 500):
